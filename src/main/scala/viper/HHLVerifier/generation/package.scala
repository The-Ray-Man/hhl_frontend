...
/** Viper Code Generation related functionality. This package contains all code related to the generation of new viper code.
  *
  * ==File Structure==
  *   - [[viper.HHLVerifier.generation.AxiomParser]] contains code related to parsing and loading axioms for handling custom composite types.
  ...
  *
  * ==Usage==
  * Call `Generator.generate` with a HHLProgram and the source code to generate a Viper AST. This might fail and throw and error.
  */
