...
case class AdditionCombineFunctionHypertype(
...
) extends binaryCombineFunction[HyperTypeConclusion](rules) {}

case class AdditionCombineFunctionDeltatype(
...
) extends binaryCombineFunction[DeltaConclusion](rules) {}

case class AdditionDerivationRule(val combineFunctionHypertype: binaryCombineFunction[HyperTypeConclusion] = AdditionCombineFunctionHypertype(), val combineFunctionDelta: binaryCombineFunction[DeltaConclusion] = AdditionCombineFunctionDeltatype()) extends ExpressionDerivationRule {
